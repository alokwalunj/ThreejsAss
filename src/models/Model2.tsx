		...
		<group ref={group} dispose={null}>
			<group name="Scene" onClick={(ev) => ev.stopPropagation()}>
				...
				{/* <group name="neon_burger"> */}
					...
					/>
				{/* </group> */}
				<mesh geometry={nodes.arcade_neon.geometry} material={materials.light_purple} />
				<mesh geometry={nodes.arcade_screen.geometry} material={materials['light_bcube.005']} />
			</group>
		</group>
	)
}
useGLTF.clear("/path/to/your/build2.glb");
